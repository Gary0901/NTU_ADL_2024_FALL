...
"""
Configuration saved in ./output/qa/config.json
Model weights saved in ./output/qa/model.safetensors
tokenizer config file saved in ./output/qa/tokenizer_config.json
Special tokens file saved in ./output/qa/special_tokens_map.json
09/28/2024 22:52:39 - INFO - __main__ - {
    "exact_match": 79.02957793286807,
    "f1": 79.05173368782542
}
"""