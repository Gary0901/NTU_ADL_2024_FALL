...
def parse_args():
    ...
    parser.add_argument(
        "--model_name_or_path",
        type=str,
        default = "hfl/chinese-lert-base", #有改!
    ...
    parser.add_argument("--num_train_epochs", type=int, default=1, help="Total number of training epochs to perform.") #改成1
    parser.add_argument(
        "--max_train_steps",
        type=int,
        default=None,
    ...
    parser.add_argument(
        "--context_file",type=str,default=None,help="Path to the context.json file."
    )
...
def main():
    ...
    def preprocess_function(examples,tokenizer,max_length,padding,context_dict):
    ...
    with accelerator.main_process_first():
        processed_datasets = raw_datasets.map(
            lambda x: preprocess_function(x, tokenizer, args.max_seq_length, padding, context_dict),
            batched=True,
